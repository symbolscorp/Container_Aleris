...
const Register = () => {
  ...
  const validateStep1 = () => {
    const { nombre, apellido, nacimiento, apodo, dni, genero, telefono, email } = form;
    if (!nombre || !apellido || !nacimiento || !apodo || !dni || !telefono || !genero || !email) {
